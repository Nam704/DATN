...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('product_custom_attributes', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('user_custom_attribute_value_id');
            $table->foreign('product_id')->references('id')->on('products')->onDelete('cascade');
            $table->foreign('user_custom_attribute_id')->references('id')->on('user_custom_attributes')->onDelete('cascade');
            $table->foreign('user_custom_attribute_value_id')->references('id')->on('user_custom_attribute_values')->onDelete('cascade');
            $table->timestamps();
        });
    }
